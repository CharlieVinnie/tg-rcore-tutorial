...
pub trait Int { fn non_zero(&self) -> bool; }

impl Int for u8 { fn non_zero(&self) -> bool { *self != 0 } }
impl Int for u16 { fn non_zero(&self) -> bool { *self != 0 } }
impl Int for u32 { fn non_zero(&self) -> bool { *self != 0 } }
impl Int for u64 { fn non_zero(&self) -> bool { *self != 0 } }
impl Int for usize { fn non_zero(&self) -> bool { *self != 0 } }

pub fn read_zero_ended_list<T: Int, const N: usize, M: PageManager<Sv<N>>>(
    address_space: &AddressSpace<Sv<N>, M>, path: usize
) -> Result<&[T], ()> {
